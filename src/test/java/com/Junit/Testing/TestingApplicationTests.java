...
class JunitTestingApplicationTests {
	...
	@Test
	@Sql(statements = "insert into productsdata.products(id, department,name, price) values (1,'Stationary', 'Pen', '30' )",executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
	@Sql(statements = "delete from productsdata.products where name='Pen'", executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD)
	...
	@Test
	@Sql(statements = "insert into productsdata.products(id, name, price, department) values (2, 'Book2', '300', 'Stattionary')",executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
	@Sql(statements = "delete from productsdata.products where name='Book2'", executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD)
	...
	@Test
	@Sql(statements = "insert into productsdata.products(id, name, price, department) values (5, 'Book4', '300', 'Stattionary')",executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
